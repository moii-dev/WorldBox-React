    ...
    <div className="absolute top-4 left-4 z-20 flex flex-col gap-2 font-sans select-none">
      ...
      >
        ...
        <div className="flex items-center gap-1 px-2.5 py-1 rounded-xl bg-amber-950/60 border border-amber-800/70 text-amber-200">
          ...
          <span className="text-xs font-mono font-bold">Year {gameYear}</span>
        </div>

        {/* Kingdoms */}
        <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-slate-800/70 border border-slate-700/50">
          <Crown className="w-3.5 h-3.5 text-amber-400" />
          <span className="text-xs text-slate-400 font-medium">Kingdoms:</span>
        ...
        <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-slate-800/70 border border-slate-700/50">
          ...
          <span className="text-xs text-slate-400 font-medium">Towns:</span>
        ...
        {activeWarsCount > 0 && (
          <div className="flex items-center gap-1 px-2 py-1 rounded-xl bg-rose-950/70 border border-rose-700/70 text-rose-300 animate-pulse">
            ...
            <span className="text-xs font-bold font-mono">{activeWarsCount} War</span>
          </div>
        )}
        ...
        <button
          ...
          title="Click to view demographic breakdown"
        >
        ...
        {/* Natural Resources */}
        <div className="hidden sm:flex items-center gap-1 px-2 py-1 rounded-xl bg-slate-800/70 border border-slate-700/50">
          ...
          <div className="mt-2 space-y-1.5 text-xs">
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5 text-emerald-400">
                <span className="w-2.5 h-2.5 rounded-sm bg-emerald-600 inline-block" /> Plains
              </span>
              <span className="font-mono text-slate-300">{biomes.plains}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5 text-green-500">
                <span className="w-2.5 h-2.5 rounded-sm bg-green-800 inline-block" /> Forest
              </span>
            ...
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5 text-sky-200">
                <Snowflake className="w-3 h-3 text-sky-300" /> Snow Peaks
              </span>
              <span className="font-mono text-slate-300">{biomes.snow}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="flex items-center gap-1.5 text-amber-300">
                <span className="w-2.5 h-2.5 rounded-sm bg-amber-500 inline-block" /> Beaches / Sand
              </span>
              <span className="font-mono text-slate-300">{biomes.sand}</span>
            </div>
            <div className="flex items-center justify-between pt-1 border-t border-slate-800 text-slate-400">
              <span className="flex items-center gap-1.5 text-cyan-400">
                <span className="w-2.5 h-2.5 rounded-sm bg-cyan-600 inline-block" /> Ocean & Waters
              </span>
